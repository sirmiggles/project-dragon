...
ALTER TABLE ClubMember
    ADD CONSTRAINT FK_MemberBorrower
        FOREIGN KEY (UserID) REFERENCES Users (UserID)
            ON UPDATE CASCADE;

ALTER TABLE NonMember
    ADD CONSTRAINT FK_NonMemberBorrower
        FOREIGN KEY (UserID) REFERENCES Users (UserID)
            ON UPDATE CASCADE;
...
ALTER TABLE Reservations
    ADD CONSTRAINT FK_UsersReservation
        FOREIGN KEY (UserID) REFERENCES Users (UserID)
            ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE Reservations
    ADD CONSTRAINT FK_ItemReservation
...
ALTER TABLE ItemGenre
    ADD CONSTRAINT FK_ItemItemGenre
        FOREIGN KEY (ItemID) REFERENCES Item (ItemID)
            ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ItemGenre
    ADD CONSTRAINT FK_ItemGenreGenre
...
ALTER TABLE ItemMechanic
    ADD CONSTRAINT FK_ItemItemMechanic
        FOREIGN KEY (ItemID) REFERENCES Item (ItemID)
            ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ItemMechanic
    ADD CONSTRAINT FK_ItemMechanicMechanic
...
ALTER TABLE ItemEquipment
    ADD CONSTRAINT FK_ItemItemEquipment
        FOREIGN KEY (ItemID) REFERENCES Item (ItemID)
            ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ItemEquipment
    ADD CONSTRAINT FK_ItemEquipmentEquipment
...
ALTER TABLE Transactions
    ADD CONSTRAINT FK_BorrowerID
        FOREIGN KEY (BorrowerID) REFERENCES Users (UserID)
            ON UPDATE CASCADE;

ALTER TABLE Transactions
    ADD CONSTRAINT FK_ApproverID
        FOREIGN KEY (ApproverID) REFERENCES Users (UserID)
            ON UPDATE CASCADE;

ALTER TABLE Transactions
    ADD CONSTRAINT FK_ReturnConfirmerID
...
ALTER TABLE ItemTag
    ADD CONSTRAINT FK_ItemTagTag
        FOREIGN KEY (TagID) REFERENCES Tag (TagID)
            ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE ItemTag
    ADD CONSTRAINT FK_ItemTagItem
        FOREIGN KEY (ItemID) REFERENCES Item (ItemID)
            ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE MemberInterest
    ADD CONSTRAINT FK_MIMember
        FOREIGN KEY (MemberID) REFERENCES ClubMember (MemberID)
            ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE MemberInterest
    ADD CONSTRAINT FK_MIInterest
...
INSERT INTO ClubRank
VALUES (NULL, 'Regular Member');
INSERT INTO ClubRank
VALUES (NULL, 'Gatekeeper');
INSERT INTO ClubRank
VALUES (NULL, 'Committee Member');

INSERT INTO Interest
VALUES (NULL, 'Card Games');
INSERT INTO Interest
VALUES (NULL, 'RPGs');
INSERT INTO Interest
VALUES (NULL, 'War Games');
INSERT INTO Interest
VALUES (NULL, 'Board Games');

INSERT INTO Users
VALUES (NULL);
INSERT INTO ClubMember
VALUES (NULL, 'John', 'Rupert', NULL, DEFAULT, 1, FALSE, 22559471, DEFAULT, 'john.rupert@hello.bye', '0452587195',
        DEFAULT, 1);
INSERT INTO Users
VALUES (NULL);
INSERT INTO ClubMember
VALUES (NULL, 'Jake', 'Bonsonby', NULL, DEFAULT, 3, TRUE, 20718595, DEFAULT, 'jake.bonsonby@au.revoir', '0449527195',
        'Destroyed several items in 2017', 2);
INSERT INTO Users
VALUES (NULL);
INSERT INTO ClubMember
VALUES (NULL, 'Alberta', 'Frederiksen', NULL, DEFAULT, 2, FALSE, 20182019, DEFAULT, 'alberta.frederiksen@bon.jour',
        '0478985195', DEFAULT, 3);
INSERT INTO Users
VALUES (NULL);
INSERT INTO ClubMember
VALUES (NULL, 'Ilanah', 'Johnson', NULL, DEFAULT, 1, TRUE, 20172018, DEFAULT, 'ilanah.johnson@guten.tag', '0452498565',
        DEFAULT, 4);
...
FROM ClubMember
         JOIN ClubRank ON (ClubMember.MemberRank = ClubRank.RankID)
ORDER BY ClubMember.MemberID;
